                ...
                builder: (context, loginProvider, child) => Column(
                  children: [
                    ...
                    SignupTextField(
                      ...
                      focusedBorder: loginProvider.invalidUsernameAccount
                      ...
                      enabledBorder: loginProvider.invalidUsernameAccount
                                  .invalidUsernameMessage !=
                              null
                          ? OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),
                      ...
                      onErrorWidget: loginProvider.invalidUsernameAccount
                                  .invalidUsernameMessage !=
                              null
                          ? Container(
                              ...
                              child: Text(
                                loginProvider.invalidUsernameAccount
                                    .invalidUsernameMessage!,
                    ...
                    SignupTextField(
                      ...
                      focusedBorder: loginProvider.invalidPasswordAccount
                      ...
                      enabledBorder: loginProvider.invalidPasswordAccount
                                  .invalidPasswordMessage !=
                              null
                          ? OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),
                      ...
                      onErrorWidget: loginProvider.invalidPasswordAccount
                                  .invalidPasswordMessage !=
                              null
                          ? Container(
                              padding: standardSpacing * 2,
                              height: height * 0.0221,
                              child: Text(
                                loginProvider.invalidPasswordAccount
                                    .invalidPasswordMessage!,
                                style: smallRegularBodyTextStyle.copyWith(
                                    color: buttonColor),
                              ))
