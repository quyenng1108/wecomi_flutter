                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Image.asset("assets/icons/bell.png", height: 24, width: 24,)),
                      )
                    ],
                  ),
                ),
                                                                      ...
                                                                      (context,
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              height: 196,
                                                                              width: 136,
                                                                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), border: Border.all(color: Theme.of(context).backgroundColor, width: 1.5)),
                                                                              child: Stack(
                                                                                children: [
                                                                                  Align(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  RichText(
                                                                    text: TextSpan(
                                                                        ...
                                                                        children: [
                                                                          TextSpan(
                                                                              text: "${groupPost!.results![index].user} • "),
                                                                          TextSpan(
                                                                            text:
                                                                                Utils.timeElasped(groupPost!.results![index].dateModified!),
                                                                            style:
                                                                                regularGreyTextStyle.copyWith(color: Color(0xff999999)),
                                                                          )
                                                                        ]),
                                                                  ),
                                                                ],
                                                                ...
                                                                onTap: () {
                                                                  Navigator.of(
                                                                      ...
                                                                      .push(CupertinoPageRoute(
                                                                          builder: (context) =>
                                                                              PostCommentScreen(index: index, id: groupPost!.results![index].id!)));
                                                                },
                                                                child:
                                                                    Container(
                                                                  decoration: BoxDecoration(
